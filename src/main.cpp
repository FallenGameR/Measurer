...
#define LCD_CS A15 // Chip Select goes to Analog 3
#define LCD_CD A14 // Command/Data goes to Analog 2
#define LCD_WR A13 // LCD Write goes to Analog 1
#define LCD_RD A12 // LCD Read goes to Analog 0

#define LCD_RESET A11 // Can alternately just connect to Arduino's reset pin
